...
function getPartByMark($html,$mark1,$mark2){
  ...
  if (strpos($url, "https") === false){
	echo "Please Input like https://wzoi.cc/s/1446/2430";
	exit(1);
  }   
...
//  echo $baseurl;
 ...
 // echo $i."-".strlen($html);
  if(strpos($html,"<h2>Description</h2>")>0){
 	 ...
 	 $descriptionHTML=getPartByMark($html,"<h3>题目描述:</h3>","空间限制");
 	 $descriptionHTML = substr($descriptionHTML,52);
  }
...
<p align=left>Source:<br><textarea name=source rows=1 cols=70>wzoi.cc</textarea></p>
